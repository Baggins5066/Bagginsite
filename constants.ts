...
import meatBroAvatar from './assets/Meat-Bro.png';
import blevitronAvatar from './assets/Blevitron.png';

export const BOTS_DATA: Bot[] = [
  {
    id: '1415012919921610864',
    name: 'Meat Bro',
    avatarUrl: meatBroAvatar,
    ...
    tags: [{ name: 'AI', icon: 'cognition_2' }, { name: 'Character', icon: 'person_book' }],
  ...
  },
  {
    ...
    tags: [{ name: 'AI', icon: 'cognition_2' }, { name: 'Commands', icon: 'data_object' }, { name: 'Humanoid', icon: 'person' }],
